    ...
    return __generator(this, function (_a) {
        ...
        switch (type) {
            case 'setup':
                ...
                self['clients'].get(e['source']['id']).then(function (client) {
...
self.addEventListener('fetch', function (e) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        if (e['request']['url'].split("/").slice(-2)[0] === 'abcdef') {
            e['respondWith'](self['clients'].get(e['clientId']).then(function (client) {
                ...
                var response = new Response(download.readableStream, {
